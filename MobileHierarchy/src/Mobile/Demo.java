...
public class Demo {
	public static void main(String[] args) {
		...
		//в ArrayList може да добавяме директно, без да пиша метод за добавяне на в Seller,
		//но все пак ги добавям през Seller за да не обезмислим методите
...
//		testStorage.posters.add(post5);
		...
		testStorage.showAllVehicles();
		
		
		//тестване на Singleton-a - правя си нов обект от тип Storage, добавям в него, обаче , реално
		//добавям в оригиналиния, а като им изпиша размера на "новия" дава, че е колкото първи, въпреки
		//че е направен току що, значи работи! 
		Storage test2 = Storage.getStorage();
		test2.posters.add(post6);
		System.out.println(testStorage.posters.size());
		System.out.println(test2.posters.size());
